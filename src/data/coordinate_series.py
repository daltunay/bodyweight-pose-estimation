...
class CoordinateSeries:
    """Class for the coordinates time series (x, y, z position values of joints over time)"""
    ...
    def __init__(self, landmarks: NormalizedLandmarkList, fps: float = 30.0):
        ...
        Args:
            ...
            * fps (float, optional): Number of frames per second of the video. Defaults to 30.0
        """
    ...
    def extract_coordinates(self) -> pd.DataFrame:
        """Method to extract the (x, y, z) coordinates of each joint, from the landmarks
    ...
    def scale(
        ...
        """Method to standardize the coordinate time series, along each axis (x, y, z)
    ...
    def smooth(
        ...
        """Method to smooth the coordinate time series, along each axis (x, y, z) along each joint
    ...
    def plot(
        ...
        Args:
            ...
            * joints (Iterable[str], optional): List of joints for which to plot the coordinates evolution. Defaults to None
            * figsize (Tuple, optional): Figure size. Defaults to (24, 10).
            * title (str, optional): Plot title. Defaults to "Joint coordinates evolution over time"
